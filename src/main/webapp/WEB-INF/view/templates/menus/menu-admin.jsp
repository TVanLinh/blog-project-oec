...
<%--<li class="list-inline btn btn-success mgr-10  mgb-15"><a href="<s:url value="/configurations"/>"><span class="glyphicon glyphicon-cog mgr-5"></span>${messageSource.getMessage("configSystem",null,locale)}</a></li>--%>
