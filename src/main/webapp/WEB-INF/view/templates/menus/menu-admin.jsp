...
<%--<img  src="<s:url value="public/asserts/images/post1.png" />" class="mgr-10 mgl--20">--%>
    ...
    <a  class="btn btn-danger menu-item  mgb-15 " href="<s:url value="/admin"/>"><i class="fa fa-book mgr-10 mgl--20" aria-hidden="true"></i>${messageSource.getMessage("post.not.approve",null,locale)}</a></li>
    <a  class="btn btn-danger menu-item  mgb-15" href="<s:url value="/manager-post"/>"><i class="fa fa-book mgr-10 mgl--20" aria-hidden="true"></i>${messageSource.getMessage("managerPost",null,locale)}</a></li>
    <a  class="btn btn-success menu-item  mgb-15" href="<s:url value="/configuration"/>"><span class="glyphicon glyphicon-cog mgr-10"></span>${messageSource.getMessage("configSystem",null,locale)}</a></li>
