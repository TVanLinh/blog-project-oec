...
<div id="search-home" class="search-hide">
    <form action="<s:url value="/view-search"/>" onsubmit="return mySearch.checkFormSearchValid('#search1')">
        <div class="input-group">
            <input type="text" name="title" id="search1" class="form-control" onsubmit="return mySearch.checkFormSearchValid('#search1')" placeholder="${messageSource.getMessage('searchBy',null,locale)} ${messageSource.getMessage('title',null,locale)}" >
