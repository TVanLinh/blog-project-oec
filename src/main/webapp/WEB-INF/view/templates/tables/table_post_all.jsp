        ...
        <c:forEach var="post"   items="${postList}"  varStatus="loop">
            <tr >
                ...
                <td>
                    ...
                    <a href="<s:url value="/manager-post-delete?page=${requestScope.page}&id=${post.id}"/>" title="${messageSource.getMessage("delete",null,locale)}" onclick="return window.confirm('Are you sure you want to delete this post?')"> <span class="glyphicon glyphicon-remove mgl-10"></span></a>
