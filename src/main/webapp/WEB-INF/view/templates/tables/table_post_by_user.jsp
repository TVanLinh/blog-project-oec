        ...
        <ul class="pager">
            ...
            <c:if test="${requestScope.querySearch!=null}">
                <c:if test="${requestScope.page>=2}">
                    ...
                    <li class="previous">
                        <a href="<s:url value="/user-post-search?page=${requestScope.page-1}&query_search=${requestScope.querySearch}"/>">&larr; ${messageSource.getMessage("back",null,locale)}</a>
                    </li>
                </c:if>
                ...
                <c:if test="${requestScope.page<=requestScope.totalPost/numberView.getNumberView()}">
                    <li class="next">
                        <c:if test="${postList.size()!=0}">
                            <a href="<s:url value="/user-post-search?page=${requestScope.page+1}&query_search=${requestScope.querySearch}"/>">${messageSource.getMessage("next",null,locale)} &rarr;</a>
                        </c:if>
                    </li>
                </c:if>
            </c:if>
